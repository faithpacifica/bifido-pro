            ...
            <div className='container px-4 mx-auto'>
                <div className='flex flex-col justify-between gap-10 lg:flex-row lg:gap-20'>
                    <div className='pl-0 lg:pl-10 mt-10 !text-center basis-full lg:basis-[28%]'>
                        <img className='lg:w-full w-[200px] sm:w-[50%] mb-6 lg:mx-0 mx-auto' src={medicineGreen} alt="immuno-medicine" />
                        <img className='lg:w-full w-[200px]  sm:w-[50%] mb-6 lg:mx-0 mx-auto' src={medicineOrange} alt="babies-medicine" />
