                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10 lg:gap-20'>
                    ...
                    <div className='basis-full lg:basis-[70%]'>
                        ...
                        <div className='overflow-auto '>
                            ...
                            <p className=' bg-gray text-white px-4 py-4 w-full mt-3 leading-4 md:leading-6'>Саше пакетик - внутрь, во время еды, предварительно растворив содержимое в грудном молоке, молочной смеси или охлажденной до комнатной температуры кипяченной воде.</p>
                        </div>
                    </div>
                </div>
            </div>
