...
const Indications = () => {
    return (
        <section className='py-12 bg-[url(./assets/images/bg-gray.png)] border-t-8 border-t-orange'>
            <h3 className='py-2 pr-10 bg-orange  text-white rounded-r-[50px] w-[350px] text-right text-3xl'>Как принимать</h3>
            <div className='container'>
                <div className='flex justify-between gap-20'>
                    <div className='pl-10 mt-10 basis-[28%]'>
                        <img className=' w-full' src={medicineGreen} alt="immuno-medicine" />
                        <img className=' w-full' src={medicineOrange} alt="babies-medicine" />
                        <AnimationButton customClass=" rounded-full font-semibold px-6 bg-orange mt-8 inline-block text-white  border-2 border-green text-lg">Разрешен с рождения</AnimationButton>
                    </div>
                    <div className='basis-[70%]'>
                        <h4 className='font-semibold text-3xl mb-2 text-gray'>Bifido PRO <span className='!text-2xl'>капсула:</span></h4>
                        <table>
                            <tr>
                                <th className='bg-green border-[2px] border-solid border-gray text-white text-xl'>Возраст</th>
                                <th className='bg-green border-[2px] border-solid border-gray text-white text-xl'>Дозировка</th>
                            </tr>
                            <tr>
                        ...
                        <table className='mt-20'>
                            <tr>
                                <th className='bg-orange border-[2px] border-solid border-gray text-white text-xl'>Возраст</th>
                                <th className='bg-orange border-[2px] border-solid border-gray text-white text-xl'>Дозировка</th>
                            </tr>
                            <tr>
